...
public class ObjectFactory {
    ...
    private final static QName _GetStudents_QNAME = new QName("http://hello.soa.agh.edu.pl/", "getStudents");
    private final static QName _GetStudentsResponse_QNAME = new QName("http://hello.soa.agh.edu.pl/", "getStudentsResponse");
    private final static QName _Hello_QNAME = new QName("http://hello.soa.agh.edu.pl/", "hello");
    private final static QName _HelloResponse_QNAME = new QName("http://hello.soa.agh.edu.pl/", "helloResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hello.soa.agh.edu.pl/", name = "getStudents")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hello.soa.agh.edu.pl/", name = "getStudentsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hello.soa.agh.edu.pl/", name = "hello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hello.soa.agh.edu.pl/", name = "helloResponse")
